# Generated by Powerlevel10k configuration wizard on 2025-06-11 at 11:19 CDT.
...
# no frame, darkest-ornaments, compact, few icons, concise, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=35
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=137
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=137
  ...
  # My config. Show the last error code only once.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SHOW_ONCE=true
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=241
