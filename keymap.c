...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
     * |        |        | PR SCR |TO(_KB) |TO(_MD) |        |        |        |        | HOME   | PG DN  | PG UP  | END    |        |        |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
	...
	[_GT] = LAYOUT_ortho_5x15( /* GOTO */
		...
		_______, _______, KC_PSCR, TO(_KB), TO(_MD), _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
