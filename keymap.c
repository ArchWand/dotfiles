...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_GT] = LAYOUT_ortho_5x15( /* GOTO */
		...
		_______, _______, _______, TO(_KB), TO(_MD), _______, _______, _______, _______, _______, TO(_MD), TO(_KB), _______, _______, _______, 
   ...
   [_NP] = LAYOUT( /* NUMPAD */
	   ...
	   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_7,    KC_8,    KC_9,    KC_PPLS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
	   _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_4,    KC_5,    KC_6,    KC_PEQL, KC_PENT, XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT,  
	   _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_1,    KC_2,    KC_3,    KC_DEL,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, 
	   _______, _______, _______, _______, LAYER,   KC_SPC,  KC_0,    KC_PDOT, KC_PDOT, KC_BSPC, LAYER,   _______, _______, _______, _______  
   ),
