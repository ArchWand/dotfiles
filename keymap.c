...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * | LCTRL  | LGUI   | LGUI   | LALT   | LAYER  | SPACE  | LEFT   | DOWN   | RIGHT  | BACKSP | LAYER  | DEL    | RALT   | RGUI   | RCTRL  |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
		...
		KC_LCTL, KC_LGUI, KC_LGUI, KC_LALT, LAYER,   KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, LAYER,   KC_DEL,  KC_RALT, KC_RGUI, KC_RCTL
	 ),

    /* MOVE TO
     * .--------------------------------------------------------------------------------------------------------------------------------------.
     * | ESC    | F1     | F2     | F3     | F4     | F5     | F6     |TO(_PL) | F7     | F8     | F9     | F10    | F11    | F12    | BACKSP |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
     * |        | PR SCR |TO(_MD) |TO(_KB) |        |        |        |        |        | HOME   | PG DN  | PG UP  | END    |        |        |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
     * |        |        |TO(_AP) |TO(_NP) |        |        |        |        |        | LEFT   | DOWN   | UP     | RIGHT  |        | ENTER  |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------|
     * |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * |        |        |        |        | LAYER  |        |        |        |        |        | LAYER  | MENU   |        |        |        |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
	[_MV] = LAYOUT_ortho_5x15( /* GOTO */
		KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   TO(_PL), KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_BSPC,
		_______, KC_PSCR, TO(_MD), TO(_KB), _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
		_______, _______, TO(_AP), TO(_NP), _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_ENT,
