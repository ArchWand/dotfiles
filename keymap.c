...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
     * |        |        |TO(_GM) |TO(_KB) |TO(_MD) |        |        |        |        |        |TO(_MD) |TO(_KB) |TO(_GM) |        |        |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
     * |        |        |TO(_AP) |TO(_NP) |TO(_MV) |        |        |TO(_PL) |        |        |TO(_MV) |TO(_NP) |TO(_AP) |        |        |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
     * |        |        |        |        |        |        |        |        |        |        |        |        |        |        |        |
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * |        |        |        |        | LAYER  |        |        |        |        |        | LAYER  |        |        |        |        |
	...
	*/
   [_NP] = LAYOUT( /* NUMPAD */
	   _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CALC, 
   ...
   [_PL] = LAYOUT( /* PLOVER */
    ...
    /* Game
     * .--------------------------------------------------------------------------------------------------------------------------------------.
     * | ESC    | 1      | 2      | 3      | 4      | 5      | F1     | F2     | F3     | 6      | 7      | 8      | 9      | 0      | BACKSP |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
     * | TAB    | Q      | W      | E      | R      | T      | F4     | F5     | F6     | Y      | U      | I      | O      | P      | '      |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
     * | CTRL   | A      | S      | D      | F      | G      | F7     | F8     | F9     | H      | J      | K      | L      | ;      | ENTER  |
     * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
     * | SHIFT  | Z      | X      | C      | V      | B      | F10    | F11    | F12    | N      | M      | ,      | .      | /      | RSHIFT |
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
     * | CTRL   | GUI    | ALT    | ALT    | SPACE  | SPACE  | SPACE  |        |        | BACKSP | LAYER  | DEL    | RALT   | RGUI   | RCTRL  |
     * '--------------------------------------------------------------------------------------------------------------------------------------'
     */
    [_GM] = LAYOUT_ortho_5x15( /* QWERTY */
		KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_F1,   KC_F2,   KC_F3,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, 
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_F4,   KC_F5,   KC_F6,   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_QUOT, 
		KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_F7,   KC_F8,   KC_F9,   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,  
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_F10,  KC_F11,  KC_F12,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, 
		KC_LCTL, KC_LGUI, KC_LALT, KC_LALT, KC_SPC,  KC_SPC,  KC_SPC,  KC_NO,   KC_NO,   KC_BSPC, LAYER,   KC_DEL,  KC_RALT, KC_RGUI, KC_RCTL  
	 ),
